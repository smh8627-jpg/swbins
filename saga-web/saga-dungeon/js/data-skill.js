 ...
 * ===============================================================
 * 원작(2편)에서 인물을 고르는 일은 **어떤 나무를 탈지**를 고르는 일이다.
 ...
 *   ─ 모양 안의 변주(2026-09-24 §5.19 몰이 사냥 2차) — `arc`(반각, 라디안)를 단 swing 은 둘레 대신
 *     앞 부채꼴을 멀리 쓸고(원뿔), `pull`(반경)을 단 nova·curse 는 먼저 적을 발밑으로 끌어 모은다
...
(function (global) {
  ...
  var SKILLS = [
    ...
    { key: 'w_cleave', cls: 'warrior', br: 0, row: 1, name: '분쇄(粉碎)', emoji: '🔨',
      shape: 'swing', cost: 28, cd: 7, v: 2.6, grow: 0.5, r: 2.8, arc: 0.8, kb: 46,
      desc: '앞으로 크게 내려쳐 부채꼴 안을 다 부순다. 멀리 밀린다.' },
    { key: 'w_quake', cls: 'warrior', br: 0, row: 2, name: '진각(震脚)', emoji: '💥',
      shape: 'nova', cost: 36, cd: 11, v: 3.0, grow: 0.6, r: 150, pull: 200, kb: 0,
      desc: '땅을 굴러 둘레의 적을 발밑으로 끌어당기고 뒤흔든다.' },
    ...
    { key: 'm_smite', cls: 'marshal', br: 1, row: 0, name: '기격(氣擊)', emoji: '✊',
      shape: 'swing', cost: 20, cd: 4, v: 1.9, grow: 0.4, r: 2.6, arc: 0.6, el: 'chi',
      desc: '기를 실어 앞 부채꼴을 멀리 친다.' },
    ...
    { key: 'y_curse', cls: 'mystic', br: 1, row: 0, name: '주박(呪縛)', emoji: '🕸️',
      shape: 'curse', cost: 20, cd: 8, v: 30, grow: 8, r: 130, pull: 190, sec: 5,
      desc: '둘레의 적을 끌어 모아 묶는다. 굼떠지고 더 아파한다.' },
    ...
    { key: 's_fan', cls: 'scholar', br: 3, row: 1, name: '선풍(扇風)', emoji: '🪭',
      shape: 'swing', cost: 20, cd: 5, v: 1.6, grow: 0.35, r: 3.2, arc: 0.7, kb: 24, el: 'cold',
      desc: '부채를 크게 휘둘러 앞 부채꼴에 찬바람을 몰아친다.' },
    ...
    { key: 'm_press', cls: 'marshal', br: 3, row: 1, name: '위압(威壓)', emoji: '📛',
      shape: 'curse', cost: 26, cd: 10, v: 32, grow: 8, r: 140, pull: 180, sec: 6,
      desc: '위세로 적을 불러 세워 굼뜨고 약하게 만든다.' },
    ...
    { key: 's_emp_nova', cls: 'scholar', br: 7, row: 1, name: '특이점(特異點)', emoji: '🕳️',
      shape: 'nova', cost: 40, cd: 14, v: 3.2, grow: 0.7, r: 140, pull: 200, el: 'emp',
      desc: '둘레의 적이 한 점으로 빨려 들다 터진다.' },
    ...
    { key: 's_flamefan', cls: 'scholar', br: 6, row: 1, name: '화선(火扇)', emoji: '🪭',
      shape: 'swing', cost: 22, cd: 6, v: 1.7, grow: 0.4, r: 3.2, arc: 0.7, kb: 20, el: 'fire',
      desc: '부채에 불을 실어 앞 부채꼴을 쓸어 태운다.' },
