...
var SHELL = [
  './',
  './index.html',
  './assets/sprites2d/mon-manifest.js',
  './assets/sprites2d/people-manifest.js',
...
self.addEventListener('fetch', function (e) {
  ...
  // 지도 타일 규칙은 남겨 둔다 — 이 게임엔 지도가 없어 사실상 타지 않는다
