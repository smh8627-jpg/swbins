  ...
  function showHelp() {
    ...
    el.innerHTML =
      '<div class="enc-card">' +
        ...
        '<div class="helplist">' +
          (core.touchOnly()
            ? ('<div><b>걷기</b> 화면 <b>아래 좌우</b>를 누릅니다 — <b>누른 채 끌면</b> ' +
                 '손가락을 따라 계속 걷습니다</div>' +
               '<div><b>점프</b> 화면 <b>위쪽</b> — 발판은 <b>위에서만</b> 밟힙니다</div>' +
               '<div><b>오르내리기</b> 밧줄·사다리 앞에서 위쪽을 누르면 오르고, ' +
                 '<b>아래 가운데</b>를 누르면 내려갑니다</div>' +
               '<div><b>앉아 쉬기</b> 아래 가운데를 누른 채 가만히 — 체력·기력이 찹니다</div>' +
               '<div><b>내려서기</b> 아래 가운데를 누른 채 위쪽 — 밟고 선 발판을 빠져나갑니다</div>' +
               '<div><b>문</b> 사냥터 끝의 빛 앞에서 <b>위쪽</b>을 누릅니다</div>' +
