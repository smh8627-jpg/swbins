...
**이야기 3부(㊼~, 2026-09-26)**: 2부 끝 실마리 "별배 날개 조각 셋이 여러 시대에 흩어졌다·구미호도 틈 너머로" — 새 지역 대신 탐사 파견이 이름만 쓰던 세 자리를 실제 명소로(`world/era_sites.gd`). 순서: ~~㊼-1 제13장 녹슨 조선소의 날개(포구·현대, 기중기 오르기·용접대 지키기)~~ 끝 → ~~㊼-2 제14장 시간 틈 관측소(폐허·미래 — 떠 있는 관측대·틈 석등·시간 기둥)~~ 끝 → ㊼-3 제15장 옛 역참 길(마을·과거 — 파발꾼, 구미호 둘째 싸움, 조각 셋을 모아 별배가 뜬다·3부 동료). 이름·인물은 이 판 것(가상).
