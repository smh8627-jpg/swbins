...
**이야기 5부(㊾~, 2026-09-26)**: 4부 끝 뒤 "이어해"(후보 셋 중 첫째) — 선장을 만나러 틈 너머로. 4부처럼 새 지역부터: 여섯째 지역 틈새 갈림길(은하역 선로 끝 고개 너머, 시간 틈 안쪽 — 과거·현대·미래가 한 땅에 가장 심하게 뒤엉킴). 순서: ~~㊾-1 지역 땅~~ 끝 → ㊾-2 제19장 틈 너머 첫 정거장(막차를 타고 도착 · 선장을 만남) → 다음 장은 19장을 쓰며 정한다. 4부가 끝나면 반디가 고원 별배 빈자리(NPCS 기본)에 서는 틈을 19장에서 함께 정한다. 이름·인물은 이 판 것(가상).
