...
**이야기 4부(㊽~, 2026-09-26)**: 3부 끝 뒤 "이어해"(후보 셋 중 첫째) — 별배가 온 시대. 2부처럼 새 지역부터: 다섯째 지역 은하 나루(마을 서쪽 숲 끝 틈 고개 너머, 미래 중심에 과거 절터·현대 역). 순서: ~~㊽-1 지역 땅~~ 끝 → ~~㊽-2 제16장 별배가 돌아온 나루~~ 끝(나루지기 아라(미래) · 계류 탑 벽 타기로 신호 · 별배가 고원에서 날아와 나루에 매임 · 매인 별배 지키기 · 별배 항해 기록 "선장이 절터 종소리를 따라 틈으로") → ~~㊽-3 제17장 옛 절터의 종~~ 끝(종지기 한결(과거) · 쓰러진 종 곁 무리 · 종 감은 이끼 이무기 · 별배가 종을 들어 종각에 · 원소로 종 울리기 · "종이 다시 울리면 막차가 한 번 더 온다") → ㊽-4 제18장 은하역 막차(현대 — 기관사, 멈춘 열차, 선장의 행방·4부 동료). 이름·인물은 이 판 것(가상).
