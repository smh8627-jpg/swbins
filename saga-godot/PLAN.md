...
**남은 격차(㊴ 뒤 순서, 2026-09-25 원신 대조)**: ~~① 활 조준 사격(충전 원소 화살·과녁 퍼즐)~~ ㊵ 끝 ~~② 지도에 세계 임무 표(맡을 수 있는 !·진행 중 ◇)~~ ㊶ 끝 ~~③ 낚시~~ ㊷ 끝 ~~④ 업적~~ ㊸ 끝 ⑤ 탐사 파견 ⑥ 이야기 2부(새 지역 — 범위는 사용자와) · 사용자 결정: 기원(뽑기 — 지금은 사당 시련·등용이 인물 얻는 길). 이름·그림·수치는 이 판 것으로(오마주 규칙 그대로).
