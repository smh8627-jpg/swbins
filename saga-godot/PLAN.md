...
**남은 격차(㉜ 뒤 순서)**: 편성 화면(명단 넷 고르기·빼기, 원신 파티 편성) → 이야기 일곱째 장(넷째 제단 — 포구 바다 밑? 검은 가면 둘째 대결) → 이야기 동료 더(촌장·사공 — 장 보상으로)(세상에 서 있거나 이야기로 만나는 인물이 늘 때, 갈래보다 한 단 위로). 이름·그림·수치는 이 판 것으로(오마주 규칙 그대로).
