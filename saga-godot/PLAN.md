...
**남은 격차(㉗ 뒤 순서)**: 이야기 넷째 장(가면 쓴 나그네 — 새 인물·새 자리) · 대화 연출 둘째 단계(인물 몸짓·입 모양, 지금은 카메라만) → 고유 스킬 손으로 더(세상에 서 있거나 이야기로 만나는 인물이 늘 때, 갈래보다 한 단 위로). 이름·그림·수치는 이 판 것으로(오마주 규칙 그대로).
