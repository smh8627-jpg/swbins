...
const REGION_NAMES := {"village": "청하 마을", "coast": "갯바람 포구", "ruins": "잿빛 폐허", "frost": "서리봉 고원", "skyport": "은하 나루", "crossing": "틈새 갈림길"}
...
const REGION_STATUE := {"village": "v_statue", "coast": "c_dock", "ruins": "r_statue", "frost": "f_statue", "skyport": "s_statue", "crossing": "x_statue"}
