...
**개발은 계속 진행** — VERTICAL_SLICE.md 12단계 루프 중 남아 있던 "도적이
부대에 합류한다"·"부대 전투력이 올랐다는 걸 화면에서 확인한다"를
2026-09-11⑥에서 최소 구현으로 채웠다(아래 "완료 단계" 참고). 마지막
남은 한 단계는 **"저장한다 → 다시 켜서 이어진다"**(Phase 9 Save/Load) —
지금은 부대 상태가 게임을 껐다 켜면 사라진다. 다음 개발은 여기부터.
