...
- **다음에 할 일**: 시나리오 200/208년·타 세력 AI·3D 몬스터 자산(균열·
  폐허·묘역)만 남는다. 셋 다 새 하부구조가 필요한 큰 항목이라, 다음
  세션은 먼저 범위를 좁히는 결정부터 하거나 스스로 가장 작게 쪼개
  시작할 것. 그 밖엔 REALM 밖(다른 네 판·saga-unity 트랙)으로.
