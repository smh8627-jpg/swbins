...
남은 건 **모바일 프로파일 실기 확인**(GLB 자산들이 저사양 기기에서
어떻게 보이는지) — 그리고 이번에 새로 만든 **마을집 벽 격자 조립이
실제 화면에서 진짜 벽처럼 보이는지**(안쪽이 비어 있어도 밖에서 보면
꽉 찬 벽과 구별 안 될 거라 예상했지만 GUI로 아직 확인 안 함)도 같이
몰아서 볼 것.
