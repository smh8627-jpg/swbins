...
- **이야기 임무**(2026-09-24): 미니맵 밑 금빛 글자가 지금 목표와 거리, 세상엔 금빛 기둥, 지도엔 금빛 마름모. 제1장은 마을 역참 옆 촌장 누리부터 — 동쪽 숲 끝의 돌개바람 수리왕, 포구 사공, 폐허 어귀 졸개 넷, 학자, 제단(원소 스킬을 제단 곁에서), 촌장으로 돌아가면 끝(인연 매듭 2 등). 제2장은 모험 등급 5 에 열리고 주간 보스까지. 자동 점검: `SAGA_STORY_PROBE=1` → `STORY_PROBE_DONE fails=0`.
