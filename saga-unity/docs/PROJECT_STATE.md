...
마지막 갱신: 2026-09-24 (서른여섯 세션째 — **PLAN 107장 신설: GO 원신 기준(전투 시스템·지도 형태), ① 들판 전투 완료**(무대 전환 없는 적 무리 6곳·J 3타·E 스킬·Q 폭발·회피·동료 교체 1~4·원소 3/반응 3·스태미나). 106장 DUNGEON 순서 1~4 는 앞 세션에 끝남, 순서 5 는 107 ② 뒤로. 헤드리스 통과, 실기 확인은 전. 경위는 HISTORY 날짜 grep).
...
|---|---|---|---|---|---|
| GO | `TestVillage` | 완료 — 도적의 습격(이동·촌장·상인·나그네·조우·전투·등용·EXP·장비·루트·저장 v13) | 동물 Group·나그네·은닉 보물·산신당·행운 돌탑·동굴 유물·채집 · 101-2 ④⑦③: 일과판·승급 3택·75초 토벌 · ①⑥⑧: 봉수대·인연·패배 비용·회수 · ②: 사당 시련(파도 3·인장 조각) · **107 ①(2026-09-24) 들판 전투**(`Combat/` — 적 15·원소 반응·교체·스태미나) | Player·주요 Enemy·Environment·Building 전부 GLB/PBR, Props는 fence·fenceGate만(lantern·stall 보류), Rocks/Vegetation은 procgen 트라이플레이너(102-4) | 전부 붙음. 목표판/세션카드(A·B). 101-3 C·F·G 전부 완료 |
...
0. **PLAN 107장 GO 원신 기준이 최우선**(사용자 2026-09-24 "지금 바로"). ① 들판 전투 완료 → 다음 **② 이동**: 점프(Space·버튼)·등반(가파른 면·꼭대기 넘어오르기)·활공(발밑 4m+)·수영, `GoStamina` 공용. 그다음 ③ 지역 지도(산=6m 막힌 상자 → 오를 수 있는 고원·절벽, 랜드마크, 순간이동 지점, M 지도). 등반·활공 클립은 `tools/mixamo_automation`(로그인만 사람 몫). ② 끝나면 DUNGEON 106 순서 5(점프·등반)는 판별 복사로 가볍게. 106-4 남은 것: 능묘지기 전용 모델·층 두목 변형·다른 판 NPC.
0-1. **107 ① 남은 것**: 새 글자 `field.*` 가 `GoLocalization.T(키, 한국어)` 폴백 — ko/en 표(다섯 벌 md5)에 넣기. 동료 교체는 몸이 안 바뀌고 원소 빛깔만(⑥).
...
| GO `PlaytestHeadless` | **3연속 OK(2026-09-24, 107 ① 뒤)** — 새 `PlaytestGoFieldCombat`(반응 표·적 15·3타/콤보·처치 경험치·증발/과부하/감전·스킬/폭발·발견→예고→피격·회피 무적·교체·전멸 복귀·DuelGate·진짜 onClick) |
...
- GO: **들판 전투(107 ①) — 3타 간격·예고 0.6s 가 피할 만한지·적 체력(산적 320·해골 220)·HUD(체력·기력·스태미나·명단·버튼) 자리·교체 빛깔·산적/해골 크기**, 조우·전투·등용 손맛, 상점·퀘스트 대사, 은닉 보물·산신당·돌탑·유물, 채집, 목표판/세션카드, hitstop, 유품 마커·무기 소켓·지형 데칼, 일과판·승급 3택, 75초 토벌, 봉수대·인연·짐 드롭/회수, 사당 시련, 울타리 목재 톤, 나무·바위 트라이플레이너 톤, 마을집 실루엣, 카메라 벽 pull-in, **폰에서 설정·승급 3택·저장 버튼이 눌리는지(2026-09-23 고침)**
