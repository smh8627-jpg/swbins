...
마지막 갱신: 2026-09-25 (109-10-2 DUNGEON 비전. 헤드리스 3연속).
...
0. **다음 = PLAN 109장 10-3(DUNGEON 웹 5.11 시련 — 대균열식 15분 시간 도전)**, 그 뒤 5.12 … 5.19(한 절 = 한 조각), 그다음 11부터 표 순서대로(건너뛰기 금지).
...
| `PlaytestDungeonHeadless` | **3연속 OK(2026-09-25, 비결 뒤)** — Secrets·EraDecor·Eras·Landmarks·BossIntro·Party·Explore·NpcModels·Temple(+컷)·LockOn·EnemyTelegraph. 같은 씬 `FloorProgression` OK |
