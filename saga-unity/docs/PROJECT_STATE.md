...
- `PlaytestStorySlice` 가 가끔(2026-09-24 6회 중 1) `PartySwapWait` 에서 "동료 서명(기탄) 뒤에도 더미가 안 죽음" — 실시간 투사체 대기, 재실행하면 통과.
