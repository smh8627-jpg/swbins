...
마지막 갱신: 2026-09-25 (109-8 GO 스킬 모양 넷·교체 연출. 헤드리스 3연속, 실기 확인 전).
...
0. **다음 = PLAN 109장 9(C 웹 변경 이식 첫 줄 — GO 건물 가림 카메라·⑰ 중 107-2 에 없는 것)**, 그 뒤 10부터 표 순서대로(건너뛰기 금지).
...
| GO `PlaytestHeadless` | **3연속 OK(2026-09-25, 109-8 뒤)** — `PlaytestGo` SkillShapes(모양 넷·교체 연출)·HeroLooks·HeroDex·Heroes·Eras·RegionProps·RegionTraits·RegionMission(v17/v15)·Guardian·SlopesBiome·PartyBodies·ElementalFoe·Treasure·WorldMap(v17/v13)·Traversal·FieldCombat (항목은 각 파일 요약 주석) |
