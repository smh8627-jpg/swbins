...
마지막 갱신: 2026-09-19 (이어서 **PLAN 101-2 ⑦ GO 승급 3택** — 레벨업마다 공/수/보 카드 3장, 고르면 그 축 배율만 갈아 끼우고 기초 능력치는 불변, 거절하면 돈 +10. `PerkState`(풀 12)·`PerkChoiceUi`, `SaveState` v11). 그 앞: **PLAN 101-2 ④ GO 일과판**. 그 앞: **REALM 51장 16~35차 확장** — 교주·남중·복양(막북) 세 사슬 전부 닫힘. **Maria/Abe/Brute Mixamo 실자산 확보 + GUI 육안 확인**·**PLAN 101-3 C·F·G 전부 적용**은 그 앞 세션들.
...
|---|---|---|---|---|---|
| GO | `TestVillage` | 완료 — 도적의 습격(이동·촌장·상인·나그네·조우·전투·등용·EXP·장비·루트·저장 v11) | 동물 Group·나그네·은닉 보물·산신당·행운 돌탑·동굴 유물·채집·오버월드 지도 · **101-2 ④ 일과판**(날짜 해시 3택, 도장 7=주간 보상) · **101-2 ⑦ 승급 3택(2026-09-19)**: 레벨업마다 공/수/보 카드 3장(`PerkState`, 풀 12), 골라 갈아 끼우거나 거절(돈+10) | Player·주요 Enemy·Environment·Building·Props 전부 GLB/PBR | 전부 붙음. **목표판/세션카드(101-2 A·B)**. **101-3 C·F·G 전부 완료(2026-09-17)** |
...
1. **PLAN 101-2 이어서** — GO는 ④·⑦ 다음 **③ 75초 토벌**(부위·저스트 회피). 다른 네 판(DUNGEON/FOREST/STORY/REALM)의 101-2 둘째·셋째 항목(축복 3택·유품·관계 하트·직업 정체성·일기토 등, 101-2 표 참고)도 saga-web 검증 대기 없이 착수 가능.
...
| 검증 | 결과 |
|---|---|
| `-batchmode -nographics -quit` 컴파일 | exit 0, 오류 0(GO 승급 3택 추가 뒤 재확인) |
| `PlaytestHeadless`(GO) | **3연속 OK**(2026-09-19, 승급 3택 추가 뒤 — 카드 표시·선택 시 배율만 오르고 기초치 불변·거절 시 돈+10·축 분포 50회 검증 포함) |
...
- GO: 조우·전투·등용 손맛, 상점·퀘스트 대사 3단계, 은닉 보물·산신당·돌탑·유물, 채집, 목표판/세션카드, hitstop 체감, 유품 마커·무기 소켓·지형 데칼(101-3 F·G), 일과판 3택·도장 UI, **승급 3택 카드 UI·손맛(101-2 ⑦, 2026-09-19 신규 — 이게 첫 실기 확인)**
