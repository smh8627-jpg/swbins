...
0. **다음 = PLAN 109장 10-4(DUNGEON 웹 5.12 고정 세계 지역 아홉)**, 그 뒤 5.13 … 5.19(한 절 = 한 조각), 그다음 11부터 표 순서대로(건너뛰기 금지).
...
| `PlaytestDungeonHeadless` | **3연속 OK(2026-09-25, 비결 뒤)** — Trial·Secrets·EraDecor·Eras·Landmarks·BossIntro·Party·Explore·NpcModels·Temple(+컷)·LockOn·EnemyTelegraph. 같은 씬 `FloorProgression` OK |
| GO `PlaytestHeadless` | **3연속 OK(2026-09-25, 109-9 뒤)** — `PlaytestGo` Peaks(정상·폭포·카메라·v18/v17)·SkillShapes·HeroLooks·HeroDex·Heroes·Eras·RegionProps·RegionTraits·RegionMission(v17/v15)·Guardian·SlopesBiome·PartyBodies·ElementalFoe·Treasure·WorldMap(v17/v13)·Traversal·FieldCombat (항목은 각 파일 요약 주석) |
