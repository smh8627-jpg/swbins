...
마지막 갱신: 2026-09-24 (마흔일곱 세션째 — PLAN 106 전부 + 106-7·106-8 두목 컷 + **GO 107-7 망루 수호장(두 겹 방패, 세이브 v15) + 106-9 수호장 등장 컷**(GO 카메라도 하이브리드). 헤드리스 통과, 실기 확인 전. 경위는 HISTORY 날짜 grep).
...
|---|---|---|---|---|---|
| GO | `TestVillage` | 완료 — 도적의 습격(이동·촌장·상인·나그네·조우·전투·등용·EXP·장비·루트·저장 v13) | 동물 Group·나그네·은닉 보물·산신당·행운 돌탑·동굴 유물·채집 · 101-2 ④⑦③: 일과판·승급 3택·75초 토벌 · ①⑥⑧: 봉수대·인연·패배 비용·회수 · ②: 사당 시련(파도 3·인장 조각) · **107 ①~⑥ (2026-09-24)** 들판 전투 + 이동 + 지역 지도(세이브 v14) + 보물 상자 16 + 원소 쓰는 적 8 + 동료 몸 교체 · **107-7** 망루 수호장(v15)·106-9 등장 컷 | Player·주요 Enemy·Environment·Building 전부 GLB/PBR, Props는 fence·fenceGate만(lantern·stall 보류), Rocks/Vegetation은 procgen 트라이플레이너(102-4) | 전부 붙음. 목표판/세션카드(A·B). 101-3 C·F·G 전부 완료 |
...
0. **PLAN 106** — DUNGEON 1~6·106-7, STORY 106-8, GO 106-9(+107-7 수호장) 두목 컷까지 완료. 다음 후보: GO 107 지역 사명 사슬(웹 ⑬) · STORY 파티·소환(5-8 교대와 결이 달라 사용자와) · 106-6 전용 클립·소환수 모델. GO 107장은 전부 코드 완료(식생 바이옴 보류).
...
| GO `PlaytestHeadless` | **3연속 OK(2026-09-24, 107-7·106-9 뒤)** — `PlaytestGo` Guardian·SlopesBiome·PartyBodies·ElementalFoe·Treasure·WorldMap(세이브 v14/v13)·Traversal·FieldCombat (항목은 각 파일 요약 주석) |
