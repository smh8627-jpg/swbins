...
namespace Saga.Story.Data
{
    ...
    /// 이미 있는 `StoryAudio.SfxVolume`을 0/1로 그대로 쓴다.
    /// </summary>
    public static class StorySettingsState
    {
        private const string VibrationKey = "saga_story_vibration_on";
        private const string UiScaleKey = "saga_story_ui_scale";
        private const string GraphicsQualityKey = "saga_story_graphics_quality_high";
        ...
        {
            int idx = System.Array.IndexOf(UiScaleSteps, UiScaleMultiplier);
            return StoryLocalization.T(UiScaleKeys[idx < 0 ? 1 : idx]);
        }
        ...
        public static string GraphicsQualityLabel() => StoryLocalization.T(HighGraphicsQuality ? "quality.high" : "quality.low");
