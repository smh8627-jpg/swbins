...
namespace Saga.Story.Data
{
    ...
    /// `Resources/Localization/story_&lt;lang&gt;.json`에서 읽어 온다(다섯 판이
    ...
    {
        private const string LanguageKey = "saga_story_language";
        ...
        public static string T(string key)
        {
            ...
            Saga.Core.SagaUi.MissingText?.Invoke("story", key, key);
            return key;
        }
        ...
        public static string T(string key, string fallback)
        {
            EnsureLoaded();
            if (_table != null && _table.TryGetValue(key, out var value)) return value;
            Saga.Core.SagaUi.MissingText?.Invoke("story", key, fallback);
            return fallback;
        }
        ...
        public static int RelocalizeScene()
        {
            ...
            if (_koReverse == null)
            {
                ...
                var asset = Resources.Load<TextAsset>("Localization/story_ko");
        ...
        private static void EnsureLoaded()
        {
            ...
            var asset = Resources.Load<TextAsset>($"Localization/story_{lang}");
            if (asset == null)
            {
                Debug.LogWarning($"[StoryLocalization] Resources/Localization/story_{lang}.json을 못 찾음");
                return;
            }
