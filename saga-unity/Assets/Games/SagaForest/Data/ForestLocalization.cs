...
namespace Saga.Forest.Data
{
    ...
    /// `Resources/Localization/forest_&lt;lang&gt;.json`에서 읽어 온다(다섯 판이
    ...
    /// </summary>
    public static class ForestLocalization
    {
        private const string LanguageKey = "saga_forest_language";
        ...
        public static string T(string key)
        {
            ...
            Saga.Core.SagaUi.MissingText?.Invoke("forest", key, key);
            return key;
        }
        ...
        public static string T(string key, string fallback)
        {
            EnsureLoaded();
            if (_table != null && _table.TryGetValue(key, out var value)) return value;
            Saga.Core.SagaUi.MissingText?.Invoke("forest", key, fallback);
            return fallback;
        }
        ...
        public static int RelocalizeScene()
        {
            ...
            if (_koReverse == null)
            {
                ...
                var asset = Resources.Load<TextAsset>("Localization/forest_ko");
        ...
        private static void EnsureLoaded()
        {
            ...
            var asset = Resources.Load<TextAsset>($"Localization/forest_{lang}");
            if (asset == null)
            {
                Debug.LogWarning($"[ForestLocalization] Resources/Localization/forest_{lang}.json을 못 찾음");
                return;
            }
