...
namespace Saga.Forest.Data
{
    ...
    /// 이미 있는 `ForestAudio.SfxVolume`을 0/1로 그대로 쓴다.
    /// </summary>
    public static class ForestSettingsState
    {
        private const string VibrationKey = "saga_forest_vibration_on";
        private const string UiScaleKey = "saga_forest_ui_scale";
        private const string GraphicsQualityKey = "saga_forest_graphics_quality_high";
        ...
        {
            get => ForestAudio.SfxVolume > 0.5f;
