...
namespace Saga.Dungeon.Data
{
    ...
    public static class DungeonLocalization
    {
        ...
        public static string T(string key)
        {
            ...
            Saga.Core.SagaUi.MissingText?.Invoke("dungeon", key, key);
            return key;
        }
        ...
        public static string T(string key, string fallback)
        {
            EnsureLoaded();
            if (_table != null && _table.TryGetValue(key, out var value)) return value;
            Saga.Core.SagaUi.MissingText?.Invoke("dungeon", key, fallback);
            return fallback;
        }
        ...
        public static int RelocalizeScene()
        {
            ...
            if (_koReverse == null)
            {
                ...
                var asset = Resources.Load<TextAsset>("Localization/dungeon_ko");
