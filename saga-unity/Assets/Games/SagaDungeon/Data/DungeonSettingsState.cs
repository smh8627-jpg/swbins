...
namespace Saga.Dungeon.Data
{
    ...
    /// 이미 있는 `SfxPlayer.SfxVolume`을 0/1로 그대로 쓴다.
    /// </summary>
    public static class DungeonSettingsState
    {
        private const string VibrationKey = "saga_dungeon_vibration_on";
        ...
        {
            int idx = System.Array.IndexOf(UiScaleSteps, UiScaleMultiplier);
            return DungeonLocalization.T(UiScaleKeys[idx < 0 ? 1 : idx]);
        }
        ...
        public static string GraphicsQualityLabel() => DungeonLocalization.T(HighGraphicsQuality ? "quality.high" : "quality.low");
