...
namespace Saga.Realm.Data
{
    ...
    /// `Resources/Localization/realm_&lt;lang&gt;.json`에서 읽어 온다(다섯 판이
    ...
    /// </summary>
    public static class RealmLocalization
    {
        private const string LanguageKey = "saga_realm_language";
        ...
        public static string T(string key)
        {
            ...
            Saga.Core.SagaUi.MissingText?.Invoke("realm", key, key);
            return key;
        }
        ...
        public static string T(string key, string fallback)
        {
            EnsureLoaded();
            if (_table != null && _table.TryGetValue(key, out var value)) return value;
            Saga.Core.SagaUi.MissingText?.Invoke("realm", key, fallback);
            return fallback;
        }
        ...
        private static void EnsureLoaded()
        {
            ...
            var asset = Resources.Load<TextAsset>($"Localization/realm_{lang}");
            if (asset == null)
            {
                Debug.LogWarning($"[RealmLocalization] Resources/Localization/realm_{lang}.json을 못 찾음");
                return;
            }
