...
| DUNGEON | 5.1 축복 3택 5.2 유품(죽음 비용·회수) 5.3 부적 던전 티어 5.4 월드 보스 75초 5.5 난입 파도 5.6 목표판·카드 5.7 시대 퓨전 5.8 손맛 2차·가시화 | **5.8 → 5.1(완료, 2026-09-19) → 5.2** (5.7 은 웹 선행 결과 뒤. 5.8 중 hitstop·타격 VFX·죽음 표식 은 2026-09-17 완료 — 101-3 C·F 표 참고, **`LootMarker`는 101-3 F 항목이라 이 5.2(플레이어 죽음 비용·회수, 아직 미착수)와 다른 것 — 혼동 주의**. 나머지 G 항목(데칼·장비 소켓)은 남음, 성장 연출은 2026-09-17 완료. 5.1 은 웹판의 무예 4칸·서명 무예·7원소 시너지(36개 표)를 그대로 옮기지 않았다 — 이 트랙엔 원소 시스템도 다중 스킬 로드아웃도 없어, 대신 이 트랙 고유의 "하나를 크게(강공격) 대 여럿을 조금씩(회전베기)" 빌드(51장)를 직접 강화하는 공(攻)/수(守)/선(旋) 3축으로 재해석했다 — SagaGo `PerkState`(승급 3택)와 같은 구조(축마다 정확히 하나, 고르면 교체), 새 `BlessingState`. 트리거는 보스층 진입(`DungeonFormulas.IsBossFloor`, 웹판 "3층마다"와 같은 문턱)) | `PlayerCombat`·`DungeonEnemy`·`DungeonFloorRunner`·`HeroState`·`DamagePopup`·`HitSpark`·`LootMarker`·`CameraRig`·`BlessingState`·`BlessingChoiceUi` |
