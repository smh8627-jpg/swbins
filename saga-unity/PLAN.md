...
- **남은 것(다음 단계)**: STORY 소환(게이지 + 2.5D 에 맞춘 소환수 한 판·컷 — DUNGEON 106-6 결을 판별 복사) · 동료 전용 클립(선봉 방패 막기 등은 이 판엔 맞는 일이 없어 보류).
...
- 108 은 이 트랙 몫(①②③) 전부 끝. 남은 것: 지역·존 전용 소품(에셋 먼저).
