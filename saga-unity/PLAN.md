...
- 변형 배가 대상: 나무(오크 1종 → 바이옴 5×3 형태, **완료 2026-09-21** — procgen 12벌) · 바위(2 → 12, **완료 2026-09-21** — procgen 10벌+기존 2벌) · 건물 모듈(Kenney 4 → PBR 모듈 8 × 배치 조합, **완료 2026-09-21(GO)** — 새 부품 없이 곁채·굴뚝 배치 조합, `LandmarksBuilder.BuildHouseBody()`) · DUNGEON 방 셸(4 → 티어별 마모 3단, 미착수) · REALM 성벽 3단(미착수).
