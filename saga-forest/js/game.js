  ...
  function showHelp() {
    ...
    el.innerHTML =
      '<div class="enc-card">' +
        ...
        '<div class="helplist">' +
          '<div><b>이동</b> WASD · 방향키 · 빈 땅을 누르면 그쪽으로 걸어갑니다</div>' +
          '<div><b>손</b> Space (또는 아래 카드의 버튼) — 흔들기·캐기·낚기·말 걸기</div>' +
          ...
          '<div><b>곤충</b> 🦋 잠자리채(전방)가 있어야 잡습니다. ' +
            '<b>살금살금(Shift · 🐾)</b> 다가가지 않으면 달아납니다. 계절·시간대를 탑니다</div>' +
