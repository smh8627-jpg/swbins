...
(function (global) {
  ...
  function renderMap() {
    ...
    /* viewBox 를 100→125→165(폭)·100→120(높이) 로 넓혀 왔다(2026-09-03 한국,
       ...
       (min-x -60·min-y -30, 너비 225·높이 150). x/y 값 자체는 CD.CITIES
       데이터가 그대로 쥐고 있어 여기 말고 고칠 곳이 없다 */
    s += '<svg class="rmap" viewBox="-60 -30 225 150" preserveAspectRatio="xMidYMid meet">';
